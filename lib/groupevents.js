...
// Send message with optional image fallback
const sendWithOptionalDP = async (conn, jid, userJid, text) => {
    const pp = await getProfilePic(conn, userJid);
    ...
    return conn.sendMessage(jid, msg);
};
